...
\begin{multicols}{2}[\subsubsection{Low-Level}\label{sec:llos}]
    \begin{enumerate}[label=LL\arabic*., ref=LL\arabic*]
        ...
        % By-Product, Process Safety: Pathogenic, Chemical,
...
\begin{tabular}{| @{\makebox[2.4em][c]{\metricrow}} | p{9.45cm} | p{5.1cm} |} 
    ...
    Germination Success Rate                    \mlabel{m:germinationsuccess}           \hfill (\ref{ll:success})                   & \%                    \\ \hline
    ...
    Reharvest Period - Fruiting Plants          \mlabel{m:time_reharvest}               \hfill (\ref{ll:time})                      & days (each plant)     \\ \hline
    Germination Time                            \mlabel{m:time}                         \hfill (\ref{ll:time})                      & days (each plant)     \\ \hline
    Time to Harvest                             \mlabel{m:time}                         \hfill (\ref{ll:time_growth})               & days (each plant)     \\ \hline
